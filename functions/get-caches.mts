					...
					requests: [
						{
							id: 'caches',
							method: 'GET',
							url: `/sites/${siteId}/lists/${listId}/items?$expand=fields($select=Title,Coordinates,W3WLocation,Polygon,Found,Suspended,Difficulty)&$select=id,fields&$filter=fields/Suspended eq 0`,
							headers: {
